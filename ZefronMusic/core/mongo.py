...
from ZefronMusic import config, logger, userbot
...
class MongoDB:
    def __init__(self):
        ...
        self.logger = False
        # Video playback is enabled by default. A persisted toggle can override it.
    ...
    async def get_admins(self, chat_id: int, reload: bool = False) -> list[int]:
        from ZefronMusic.helpers._admins import reload_admins
